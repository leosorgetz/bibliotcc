...
CREATE TABLE `board` (
  ...
  `advisorGrade` double DEFAULT NULL,
  `evaluatorOneGrade` double DEFAULT NULL,
  `evaluatorTwoGrade` double DEFAULT NULL,
  ...
  `isPresented` tinyint(1) DEFAULT NULL,
  `evaluatorOneId` int(11) DEFAULT NULL,
  `evaluatorTwoId` int(11) DEFAULT NULL,
  `semesterId` int(11) DEFAULT NULL,
  `projectId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_58562B476C9360F7` (`projectId`),
  KEY `IDX_58562B4746B9DCBB` (`evaluatorOneId`),
  KEY `IDX_58562B47710FE7EB` (`evaluatorTwoId`),
  KEY `IDX_58562B47CB6D974C` (`semesterId`),
  CONSTRAINT `FK_58562B4746B9DCBB` FOREIGN KEY (`evaluatorOneId`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_58562B476C9360F7` FOREIGN KEY (`projectId`) REFERENCES `project` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_58562B47710FE7EB` FOREIGN KEY (`evaluatorTwoId`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_58562B47CB6D974C` FOREIGN KEY (`semesterId`) REFERENCES `semester` (`id`)
...
CREATE TABLE `project` (
  ...
  `firstPost` tinyint(1) NOT NULL,
  `firstPostDate` datetime NOT NULL,
  `lastPost` tinyint(1) NOT NULL,
  `lastPostDate` datetime NOT NULL,
  `studentId` int(11) DEFAULT NULL,
  `advisorId` int(11) DEFAULT NULL,
  `boardId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_2FB3D0EE39393B26` (`boardId`),
  KEY `IDX_2FB3D0EE98BF2F98` (`studentId`),
  KEY `IDX_2FB3D0EEB8D504F2` (`advisorId`),
  CONSTRAINT `FK_2FB3D0EE39393B26` FOREIGN KEY (`boardId`) REFERENCES `board` (`id`) ON DELETE CASCADE,
  CONSTRAINT `FK_2FB3D0EE98BF2F98` FOREIGN KEY (`studentId`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_2FB3D0EEB8D504F2` FOREIGN KEY (`advisorId`) REFERENCES `user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-15 20:08:15
